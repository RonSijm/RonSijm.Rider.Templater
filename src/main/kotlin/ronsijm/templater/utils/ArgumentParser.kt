...
/** Helpers for extracting typed values from argument lists */
object ArgumentParser {
    ...
    /** Parses "arg1", 42, [1,2,3] style argument strings */
    fun parseArgumentString(argsString: String): List<Any?> {
        ...
        var inQuotes = false
        var quoteChar = ' '
        var inArray = 0  // Track nested array depth
    ...
    fun parseValue(value: String): Any? {
        ...
        return when {
            ...
            else -> trimmed  // Return as-is if not recognized
        }
    }
